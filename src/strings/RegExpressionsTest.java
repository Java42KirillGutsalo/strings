...
;class RegExpressionsTest {
	...
	private String getStringWithoutSpaces(String str) {
		// write this method based on the method replaceAll of the class String
	...
	private String[] getOperandsExpression(String expr) {
		// the method returns array of strings containing only the operands of the given expression
	...
	private String[] getOperatorsExpression(String expr) {
		// the method returns array of strings containing the operators of the given expression
